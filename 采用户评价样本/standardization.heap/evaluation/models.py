...
class UserInfo(models.Model):
  ...
  status = models.SmallIntegerField(choices=((0, "building"),(1, "sorting")), default=0)
...
class StyleComparison(models.Model):
  ...
  order = models.SmallIntegerField(choices=((0, "<"), (1, "=="), (2, ">")), default=1)
...
class UpDownWorker(models.Model):
